...
public class MainPage {
    ...
    void GenerateSalaryF(ActionEvent event) {
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("Fxmls/GenerateSalary.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    @FXML
    void MarkAttendanceButton(ActionEvent event) {
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("Fxmls/AttendanceMark.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        Stage stage = new Stage();
